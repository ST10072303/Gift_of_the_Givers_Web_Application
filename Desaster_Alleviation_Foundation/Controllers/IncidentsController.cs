...
namespace Disaster_Alleviation_Foundation.Controllers
{
    public class IncidentsController : Controller
    {
        ...
        public IncidentsController(OrganizationContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IncidentID,Description,Date,Location,Nature")] Incident incident)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IncidentID,Description,Date,Location,Nature")] Incident incident)
        {
