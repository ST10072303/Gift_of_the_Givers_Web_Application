...
namespace Disaster_Alleviation_Foundation.Controllers
{
    public class DonationsController : Controller
    {
        ...
        public DonationsController(OrganizationContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("DonationID,DonorID,ResourceType,Quantity,Date,Destination")] Donation donation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DonationID,DonorID,ResourceType,Quantity,Date,Destination")] Donation donation)
        {
